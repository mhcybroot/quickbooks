...
@Entity
@Table(name = "bill_payment_mapping_profile")
public class BillPaymentMappingProfileEntity {
    @Id
    ...
    @CollectionTable(name = "bill_payment_mapping_profile_entries", joinColumns = @JoinColumn(name = "mapping_profile_id"))
