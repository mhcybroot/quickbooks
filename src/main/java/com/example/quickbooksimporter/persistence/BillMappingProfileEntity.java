...
@Entity
@Table(name = "bill_mapping_profile")
public class BillMappingProfileEntity {
    @Id
    ...
    @CollectionTable(name = "bill_mapping_profile_entries", joinColumns = @JoinColumn(name = "mapping_profile_id"))
